...
class NodeConfig {
  ...
  /// Ordered artwork painted over the owning Layout background and Node fill.
  ///
  /// A non-null list replaces the inherited Node background list during
  /// normal [NodeConfig] state and hierarchy merging. An empty list therefore
  /// explicitly suppresses inherited Node artwork.
