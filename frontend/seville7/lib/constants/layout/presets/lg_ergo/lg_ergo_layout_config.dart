    ...
    'safe-area': SafeAreaLayout(
      ...
      children: {
            ...
            'cortex-bush': FanLayout(
              ...
              background: [
                LayoutBackground.image(
                  assetPath: 'assets/backgrounds/multifan-pattern.webp',
                  rotationDegrees: 180,
                  repeat: 10,
        ...
        'panoramic-scene-plane': LayoutPath(
          ...
          state: LayoutState({
            LayoutCondition.hasLabelsInActiveNodes([
              'Science',
              'Section',
            ]): LayoutConfig(
              background: [
                LayoutBackground.color(Color(0xFF7B4FA3), opacity: 0.5),
              ],
            ),
          }),
          background: [
          ...
          children: {
            'direction-pad': GridLayout(
              ...
              children: {
                ...
                'find-layout': FindLayout(
                  slot: 'find-layout',
                  aliases: ['find-layout', 'node-finder', 'search-layout'],
                  background: [LayoutBackground.color(Color(0xF2283252))],
                  text: LayoutTextConfig(fontSize: 18),
                  layoutBorderWidth: 1.8,
                  state: LayoutState({
                    LayoutCondition.findOpened(): LayoutConfig(visible: true),
                  }),
                  children: {
                ...
                'scene-graph': GraphLayout(
                  ...
                  node: NodeConfig(
                    borderStyle: GuideStyle(
                      color: Color.fromARGB(104, 135, 17, 208),
                      strokeWidth: 1.8,
                      pattern: GuideLinePattern.solid,
                    ),
                  ),
                ...
                'navigation-column': ColumnLayout(
                  ...
                  children: {
                    ...
                    'refresh-fans': PanelLayout(
                      ...
                      text: LayoutTextConfig(
                        value: LayoutText.value('🔄 Refresh Fans | ⌘R'),
                      ),
                    ),
                    'find': PanelLayout(
                    ...
                    'confirm': PanelLayout(
                      ...
                      text: LayoutTextConfig(
                        value: LayoutText.value('✅ Confirm | Enter'),
                      ),
                    ),
                    'settings': PanelLayout(
                      ...
                      text: LayoutTextConfig(
                        value: LayoutText.value('⚙️ settings | O'),
                      ),
                    ),
                    'close-selection': PanelLayout(
                      ...
                      text: LayoutTextConfig(
                        value: LayoutText.value('× Close | Esc'),
                      ),
                    ),
                  },
                ),
                'possessions': RowLayout(
                  background: [
                    LayoutBackground.image(
                      assetPath: 'assets/wallpapers/dark-vintage-scheme.jpg',
                      fit: LayoutBackgroundFit.cover,
                  ...
                  text: LayoutTextConfig(
                    flow: LayoutTextFlow.vertical(
                      ...
                      glyphOrientation: LayoutTextGlyphOrientation.upright,
                    ),
                  ),
                  children: {
                    'bookmarks': PanelLayout(
